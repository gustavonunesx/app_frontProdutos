...
export default function ProdutoForm(){
  ...
  async function fetchCategorias(){
    try{
      const c = await CategoriaAPI.list();
      setCategorias(c);
    }catch(e){}
  }
  ...
  async function handleSubmit(e){
    ...
    const data = {
      ...
      categoria_id: categoriaId ? Number(categoriaId) : null // ✔ backend entende isto
    };
    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display:'flex', gap:8 }}>
          ...
          <button className="btn" type="button" onClick={()=>navigate('/produtos')}>
            Cancelar
          </button>
        </div>
